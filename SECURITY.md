...
KiCI is pre-1.0. Security fixes land on the latest `0.x` minor. Older minors are not patched — please upgrade to the latest release before reporting an issue tied to old code.
