...
/** The tracked-row git-credential fields for a job, from its lock entry. */
function gitCredentialFields(lockJob: {
  gitCredentials?: Readonly<Record<string, Readonly<Record<string, string>>>>;
}): { gitCredentials?: Readonly<Record<string, Readonly<Record<string, string>>>> } {
