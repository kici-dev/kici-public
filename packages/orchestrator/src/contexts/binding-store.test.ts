/**
 * Tests for BindingStore -- scope-to-context binding CRUD.
 *
...
describe('BindingStore', () => {
  describe('list', () => {
    it('should return all bindings for a context', async () => {
      const rows = [
      ...
      expect(mocks.selectFrom).toHaveBeenCalledWith('context_bindings');
  ...
  describe('set', () => {
    it('should replace all bindings in a transaction', async () => {
      ...
      expect(mocks.deleteFrom).toHaveBeenCalledWith('context_bindings');
      // Should insert new bindings
      expect(mocks.insertInto).toHaveBeenCalledWith('context_bindings');
    });
