...
describe('checkBindingSatisfiable', () => {
  ...
  it('treats a missing context as satisfiable (lenient, matches dispatch)', () => {
  ...
  it('flags a single bound disabled context (matches dispatch hard-reject)', () => {
  ...
  it('returns null when one context has no branch constraint', () => {
    expect(
      checkBindingSatisfiable(
        'deploy',
  ...
  it('returns null for a single bound context', () => {
    expect(
