/**
 * Tests for VariableStore -- context variable CRUD with lock enforcement.
 *
...
describe('VariableStore', () => {
  describe('listVars', () => {
    it('should return all org-level vars for context', async () => {
      ...
      expect(mocks.selectFrom).toHaveBeenCalledWith('context_variables');
      expect(mocks.selectWhere).toHaveBeenCalledWith('org_id', '=', 'org-abc');
      expect(mocks.selectWhere).toHaveBeenCalledWith('context_id', '=', 'env-001');
    });
  });
  ...
  describe('setVar', () => {
    it('should upsert a variable', async () => {
      ...
      expect(mocks.insertInto).toHaveBeenCalledWith('context_variables');
  ...
  describe('deleteVar', () => {
    it('should delete a variable', async () => {
      ...
      expect(mocks.deleteFrom).toHaveBeenCalledWith('context_variables');
      expect(mocks.deleteWhere).toHaveBeenCalledWith('org_id', '=', 'org-abc');
      expect(mocks.deleteWhere).toHaveBeenCalledWith('context_id', '=', 'env-001');
  ...
  describe('listSourceOverrides', () => {
    it('should return overrides for a source', async () => {
      ...
      expect(mocks.selectFrom).toHaveBeenCalledWith('context_source_overrides');
