...
export class EventRouter {
  ...
  async start(): Promise<void> {
    ...
    this.listener = new NotifyListener({
      ...
      // A reconnect was deaf for an unknown interval and NOTIFY keeps no
      // durable log, so the only correct catch-up is the same backlog scan
      // this class already runs at cold boot.
