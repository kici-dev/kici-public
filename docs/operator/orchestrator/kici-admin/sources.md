...
# Ask GitHub to resend this App's deliveries from a window (outage recovery)
kici-admin source redeliver <routingKey> --since <iso> --until <iso> [--dry-run] [--json]
...
### `kici-admin source redeliver`

Ask GitHub to resend a GitHub App source's webhook deliveries from a window

Synopsis: `kici-admin source redeliver <routingKey> [options]`
...
| Option          | Default | Description                                                       |
| --------------- | ------- | ----------------------------------------------------------------- |
| `--since <iso>` |         | Window start, ISO-8601 (inclusive)                                |
| `--until <iso>` |         | Window end, ISO-8601 (exclusive)                                  |
| `--dry-run`     |         | List the matching deliveries without asking GitHub to resend them |
